...
const PeojectPage = () => {
    ...
    return (
        <div className="rs-services services-main-home gray-bg py-10 px-4 md:py-20 md:px-12 lg:py-[120px] lg:px-[10em] bg-[#e8eaee]">
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    ...
                    {services.map((service, index) => (
                        <div
                            key={index}
                            className="services-item group bg-white shadow-sm border rounded-sm  overflow-hidden"
                        >
                            <div className="services-wrap relative">
                                ...
                                <div className='service-description'>
                                    ...
                                    <h2 className='text-white mb-2 text-[20px] font-semibold'>{service.title}</h2>
                                    <p className="services-txt text-white mb-4">{service.description}</p>
