                ...
                <div className="contact-section">
                    <div className="contact-wrap">
                        <div className="sec-title mb-4 md:mb-6">
                            <span className="text-black uppercase font-semibold text-sm md:text-lg">Let's Talk</span>
                            <h2 className="text-black text-2xl md:text-3xl lg:text-4xl font-bold leading-tight mb-4">Get in touch</h2>
                        </div>
