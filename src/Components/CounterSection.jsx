      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center lg:justify-between">
          ...
          <div className="text-left mb-10 lg:mb-0 lg:w-1/2">
            <span className="text-[#ffb703] font-semibold text-lg">
              Number Talks
            </span>
          ...
          <div className="lg:w-1/2 grid grid-cols-2 gap-6">
            ...
            <div className="bg-yellow-600 bg-opacity-20 p-6 rounded-md text-center text-white">
              <div className="text-4xl font-bold mb-2">
                134<span className="text-lg font-normal">+</span>
              </div>
            ...
            <div className="bg-yellow-600 bg-opacity-20 p-6 rounded-md text-center text-white">
              <div className="text-4xl font-bold mb-2">
                98<span className="text-lg font-normal">+</span>
              </div>
            ...
            <div className="bg-yellow-600 bg-opacity-20 p-6 rounded-md text-center text-white">
              <div className="text-4xl font-bold mb-2">
                39<span className="text-lg font-normal">+</span>
              </div>
