...
const Description = ({ product }) => {
  ...
  return (
    <div className="border relative border-gray-200 shadow-sm p-6 mb-4 rounded-md bg-white">
      ...
      <div onClick={() => setIsModalOpen(true)} className="absolute right-1 top-1 max-[500px]:top-[-2rem] rounded-sm !bg-[#ffda31] text-[#010d14] !font-[600] cursor-pointer !px-[40px] !py-[15px] h-auto !text-[15px] !shadow-none hover:!bg-black  hover:text-[#fff]"><DirectionsRoundedIcon className="mr-2" />Want a custom product ?</div>
